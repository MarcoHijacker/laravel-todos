...
{{--                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="subscription" type="number" class="form-control @error('subscription') is-invalid @enderror" name="subscription" value="0" required autocomplete="subscription" autofocus>
